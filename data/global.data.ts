...
export const TRANSLATIONS: Lang<Translations> = {
    en: [
        {
            key: 'Ai Egineer Full stack capable, passionate about building appealing and interactive web experiences.',
            value: 'Ai Egineer Full stack capable, passionate about building appealing and interactive web experiences.'
        },
        {
            key: 'Visit website',
            value: 'Visit website'
