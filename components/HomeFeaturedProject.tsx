...
export default function HomeFeaturedProject({
    ...
    return(
        <section className={classNames(
            'u-spacing--responsive--top',
            styles['c-homeFeaturedProject']
        )}>
            <div className="o-container">
                <div className={styles['c-homeFeaturedProject__divider']}>
                    <FadeInOut watch>
                        <div className={styles['c-homeFeaturedProject__divider--line']} />
                    </FadeInOut>
                </div>
                <div className={styles['c-homeFeaturedProject__header']}>
